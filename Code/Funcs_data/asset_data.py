...
# EXTERIOR UI ELEMENTS
EXT_UI_ELEMENTS = {
    "customers": {
        "paths": [
            f"Assets/images/exterior/customers/costumer{i}.png" for i in range(1, 7)
        ],
        "size": (SCREEN_WIDTH // 10, SCREEN_HEIGHT // 10),
    },
    "pizza_timer": {
        "paths": [
            "Assets/images/exterior/pizza_timer/full_time.png",
            *[f"Assets/images/exterior/pizza_timer/pt{i}.png" for i in range(1, 12)],
        ],
        "size": (128, 128),
    },
    "health": {
    ...
    "nitro": {
        "paths": [
            "Assets/images/exterior/ui/nitro_locked.png",
    ...
    "hole": {
        "paths": ["Assets/images/exterior/ui/hole_found.png"],
        "size": (SCREEN_WIDTH * 1.2 / 10, SCREEN_HEIGHT * 1.2 / 10),
    },
    "fix_hole": {
        "paths": ["Assets/images/exterior/ui/press_space.png"],
        "size": (SCREEN_WIDTH * 1.54 / 10, SCREEN_HEIGHT * 1.54 / 10),
    },
    "esc_interior": {
        "paths": ["Assets/images/exterior/ui/escape_exterior.png"],
        "size": (SCREEN_WIDTH * 1.54 / 10, SCREEN_HEIGHT * 1.54 / 10),
    },
    "space": {
        "paths": ["Assets/images/exterior/ui/press_space.png"],
...
# SHIP
DAMAGE_ANIMATION = {
    "paths": ["Assets/images/objects/ship/ship_damage.png"],
...
ASTEROID_CONFIG = {
    f"asteroid{i}": {
        "paths": [f"Assets/images/objects/asteroids/asteroid{i}.png"],
        "size": ASTEROID_SIZE,
